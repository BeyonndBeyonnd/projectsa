<?php
    ...
    การจ้างงานของคุณถูก (ปฏิเสธ)
    เนื่องจากตารางของช่างอาจจะไม่ว่าง
    หรือ มีเหตุด่วนอื่นๆที่ไม่สามารถรับงานได้
    หากสงสัยกรุณาติดต่อทางแฟนเพจของเรา
    Fanpage: PhotographShop Eiei
    * ".$result['DateTime']." *
    ";
    ...
    if($result['Telephone']){
        echo "<script>window.location='cancellist.php?username=".$_GET['username']."&phone=".$result['Telephone']."';</script>";
    }
