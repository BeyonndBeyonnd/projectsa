<?php
    ...
    if($result){
        ...
        $subject = "Rejected Work from PhotographShop"; // หัวข้อเมล์
            ...
            <html>
                ...
                <body>
                            ...
                            <span style='color:black;'>
                                * ขอบคุณสำหรับการจ้างงานกับเรา, เราขอปฏิเสธงานจ้างนี้ เนื่องจากช่างภาพอาจไม่มีติวงานว่างหรือไม่สามารถรับงานนี้ได้ !*<br>
                                * หากสงสัยกรุณาสอบถามเราได้ที่ แฟนเพจ หรือ LineID !*<br>
                                * ".$result['DateTime']." *<br>
                            </span>
                        </div>
        ...
        if($email_receiver){
            ...
            if (!$mail->send()) {  // สั่งให้ส่ง email
                ...
                echo "<script>alert('คุณได้ปฏิเสธงานของ ".$_GET['username']." และ ข้อความจะถูกส่งไปยังเมล ".$result['Email']."');</script>";
                echo "<script>window.location='admin.php';</script>";
