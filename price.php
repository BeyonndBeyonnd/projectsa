    ...
    <div class="main-container" >
        ...
        <div class="mainbody">
            ...
            <div class="congrad">
                ...
                <h5 class="h51">
                    เต็มวัน 4,500 บาท (เช้าก่อนเข้าหอประชุม จนถึงเย็นหลังออกจากหอประชุม)
                </h5>
                <h5 class="h52">
                    ครึ่งวัน 3,500 บาท (เช้าหรือเย็น ก่อนเข้า-ออกจากห้องประชุม ประมาณ 4 ชั่วโมง)
                </h5>
                <h5 class="h53">
            ...
            <div class="prewedding">
                ...
                <h6 class="p1">
                    Package 4,500 (4 ชั่วโมง)
                </h6>
                <h6 class="p2">
                    Package 5,500 (8 ชั่วโมง)
                </h6>
                <h6 class="p3">
